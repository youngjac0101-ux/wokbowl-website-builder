        ...
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a href={siteConfig.socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="text-background/70 hover:text-primary" aria-label="Instagram">
                <Instagram className="h-5 w-5" />
              </a>
              <a href={siteConfig.socialLinks.tiktok} target="_blank" rel="noopener noreferrer" className="text-background/70 hover:text-primary" aria-label="TikTok">
            ...
            <a href={`mailto:${siteConfig.email}`} className="mt-3 block text-sm text-background/70 hover:text-primary">
              {siteConfig.email}
            </a>
          </div>
        </div>
